...
public enum Status {
	...
	/**
	 * The file transfer is being negotiated with the peer. The party recieving
	 * the file has the option to accept or refuse a file transfer request. If
	 * they accept, then the process of stream negotiation will begin. If they
	 * refuse the file will not be transfered.
	 * 
	...
	/**
	 * The peer has refused the file transfer request halting the file transfer
	 * negotiation process.
	 */
	refused("Refused"),
	 ...
	 * stream type. After the stream negotiating process is complete the status
	 * becomes negotiated.
	 * 
	 * @see #negotiated
	 */
	 ...
	 * between the time when the negotiation is finished and the actual transfer
	 * begins.
	 */
