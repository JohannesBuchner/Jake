...
public interface ISyncService {
    ...
    /**
     * Starts a logSync with a arbitrary user of the supplied
     * <code>Project</code>
     *
     * @param project The <code>Project</code> to do the logSync
    ...
    /**
     * Starts a logSync with one specified user of the supplied
     * <code>Project</code>
     *
     * @param project
     * @param userId
     * @throws IllegalArgumentException if the suuplied project or
     *                                  userId is null
     * @throws IllegalProtocolException if the supplied UserId
     *                                  is of the wrong protocol-type
     */
    ...
    /**
     * Starts the pulling of all the supplied FileObjects
     * if pulling is necessary and possible
     *
     * @param objects the objects to be pulled
     */
    public void pullObjects(List<FileObject> objects);


    /**
     * Tries to start the pushing of all remaining files of the given Project
     *
     * @param project the project whichs objects should be pushed
     ...
     *
     * @param objects the objects to be pushed
     */
    public void pushObjects(List<FileObject> objects);


    /**
     * Gets a list of all objects that changed
     * since the last local change // TODO wirklich so??
     *
     * @param project the Project from which the changed objects
     *                should be shown
     * @return a List of changed JakeObjects
     * @throws IllegalArgumentException if the supplied
     *                                  Project is null or invalid
     */
     ...
     * @throws IllegalArgumentException if the supplied Project
     *                                  is null or invalid
     */
     ...
     *
     * @param object the JakeObject to query
     * @return true if locked, false if not or unknown
     * @throws IllegalArgumentException if the supplied JakeObject
     *                                  is null or invalid
     */
     ...
     *
     * @param object the JakeObject the lock should be set
     * @throws IllegalArgumentException  if the supplied JakeObject
     *                                   is null or invalid
     * @throws ProjectNotLoadedException if the project corresponding
     *                                   to this object is not loaded currently
     */
