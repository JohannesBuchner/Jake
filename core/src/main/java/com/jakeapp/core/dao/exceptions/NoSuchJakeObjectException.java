...
public class NoSuchJakeObjectException extends Exception {
	 ...
	 */
	public NoSuchJakeObjectException(String message) {
		super(message);
	}
	 ...
	 * @since 1.4
	 */
	public NoSuchJakeObjectException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public NoSuchJakeObjectException(Throwable cause) {
		super(cause);
	}
}
