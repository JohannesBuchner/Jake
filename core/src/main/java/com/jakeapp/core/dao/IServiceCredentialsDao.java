...
public interface IServiceCredentialsDao {
     ...
     * @throws NoSuchServiceCredentialsException if no credentials by the given UUID exist
     */
     ...
     * @throws NoSuchServiceCredentialsException if no credentials by the uuid of this credentials where in the
     * database
     */
