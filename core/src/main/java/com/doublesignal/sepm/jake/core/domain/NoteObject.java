...
/**
 * A <code>NoteObject</code> is a Extension of a JakeObject consists of
 * <code>content</code>.
 * 
...
public class NoteObject extends JakeObject {
	 ...
	 * 
	 * @param name
	 *            The name of the object, as in <code>JakeObject</code>. It
	 *            starts with 'note:'
	 * @param content
	 ...
	 * 
	 * @return <code>true</code> iff the <code>contents</code> of the two
	 *         notes are equal.
	 */
	@Override
	public boolean equals(Object obj) {
		if (obj != null && obj.getClass().equals(this.getClass())) {
			...
			if (content == null && that.getContent() != null)
				return false;
			if (content != null && !content.equals(that.getContent()))
				return false;
		}
		return true;
	}
