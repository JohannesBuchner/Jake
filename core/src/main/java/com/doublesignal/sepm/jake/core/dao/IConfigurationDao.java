...
public interface IConfigurationDao {
	 ...
	 * @throws NoSuchConfigOptionException if there is no configuration option by that name
	 */
	 ...
	 * @param value The value to be assigned to the given configuration option
	 */
	public void setConfigurationValue(String name, String value);

	/**
	 * Removes a configuration option entirely
	 * @param name The name of the configuration option to be removed (nothing will be done if there is no configuration
	 *             option by that name)
	 */
	public void deleteConfigurationValue(String name);

	/**
	 * Checks if a configuration option is set (i.e. if a configuration option by that name exists)
