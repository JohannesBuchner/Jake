...
CREATE TABLE users ( uuid CHAR(36) PRIMARY KEY, userid VARCHAR (255) NOT NULL, nickname VARCHAR (255), firstname VARCHAR (255), surname VARCHAR (255), sc_uuid CHAR (36), FOREIGN KEY (sc_uuid) REFERENCES servicecredentials(UUID) );
