...
\def\sepmauthors{Johannes Buchner, Dominik Dorn, Peter Steinberger, Simon Wallner}
\def\sepmreview{}
...
\def\sepmauthorsabbr{jb, ps}
% these are lines that are injected into the changelog table
\def\sepmchangeloglines{
1 & 11.04.2008 & Johannes Buchner, Dominik Dorn, Peter Steinberger, Simon Wallner & Dokument erstellt \\
\hline
