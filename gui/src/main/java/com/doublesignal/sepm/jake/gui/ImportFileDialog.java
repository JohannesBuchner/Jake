...
// call onCancel() on ESCAPE
    ...
    private void importButtonActionPerformed(ActionEvent event) {
        if (jakeGuiAccess.importExternalFileIntoProject(fileTextField.getText(),
                destinationFolderTextField.getText())) {
            UserDialogHelper.translatedInform(this, "ImportFileDialogSuccessMessageTitle",
                    "ImportFileDialogSuccessMessageText");
            onCancel();
        } else {
            UserDialogHelper.translatedError(this, "ImportFileDialogNotImportedMessageTitle",
                    "ImportFileDialogNotImportedMessageText");
        }
    }
            ...
            public void setCurrentDirectory(File file) {
                if (file.getAbsolutePath().startsWith(projectRootPath)) {
                    ...
                    if (selectedFile != null && selectedFile.getAbsolutePath().equals(projectRootPath)) {
                        ...
                        UserDialogHelper.translatedWarning(this, "ImportFileDialogInvalidDirectoryMessageTitle",
                                "ImportFileDialogInvalidDirectoryMessageText");
                    }
                }
            }
        };
        ...
        JFileChooser fileChooser = new JFileChooser() {
            public void setCurrentDirectory(File file) {
                ...
                if (file != null && file.getAbsolutePath().startsWith(projectRootPath)) {
                    UserDialogHelper.translatedWarning(this, "ImportFileDialogFileNotOutsideTitle",
                            "ImportFileDialogFileNotOutsideText");
                } else {
                    super.setCurrentDirectory(file);
                }
            }
