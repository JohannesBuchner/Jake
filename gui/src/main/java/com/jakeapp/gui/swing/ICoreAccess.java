...
public interface ICoreAccess {
	 ...
	 * 
	 * @param frontendService
	 *            the <code>FrontendService</code> to use by the gui
	 */
	 ...
	 *            A map consiting of credentials (not credentials to
	 *            MsgServices!)
	 ...
	 * 
	 * @param project
	 *            : project that should be deleted
	 */
	 ...
	 * 
	 * @param file
	 *            The file for which the status should be determined
	 * @return The file's status <p/> TODO: Is this really an int? TODO: //
	 *         shouldn't we refactor this to something like Enum SyncStatus
	 */
	 ...
	 * 
	 * @param project
	 *            : project that should be evaluated
	 * @return
	 */
	 ...
	 * @param project
	 *            the project the note is associated with
	 ...
	 * 
	 * @param project
	 *            : the project to invite the pm
	 * @param userid
	 *            : the user id as string (xmpp, ...)
	 */
