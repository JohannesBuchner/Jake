...
/*
 * Created by JFormDesigner on Wed May 07 16:26:11 CEST 2008
 */
 ...
 */
public class ResolveConflict extends JDialog {
	public ResolveConflict(Frame owner) {
		super(owner);
		initComponents();
	}

	public ResolveConflict(Dialog owner) {
		super(owner);
		initComponents();
	}
